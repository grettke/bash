...
#+NAME: org_grant_2023-01-21T22-30-44-06-00_donutron_87386DA5-1FB8-4E0F-AA7A-489B2485EE4B
#+begin_src sh
TRMBOLD=$(tput bold)
TRMNORM=$(tput sgr0)
#+end_src
...
typesetting; in particular, for typesetting math and other technical (from Greek
"techne" = art/craft, the stem of `technology') material.
#+end_quote
...
**** latexmk
:PROPERTIES:
:ID:       org_grant_2023-01-14T21-48-23-06-00_donutron:7AF6C4E7-6CB2-45F0-8D32-771CC1DC6ABD
:END:
...
- *-silent*
  - "Run commands silently, i.e., with options that reduce the amount of
    diagnostics generated. For example, with the default settings, the command
...
- *-bibtex *
  - "When the source file uses bbl files for bibliography, run bibtex or biber
...
This is function for normal usage
...
Tangle it into a script so that Org can use it.

#+NAME: org_grant_2023-01-14T22-54-40-06-00_donutron_B6935AEC-F9B9-45F8-8AD5-7627AD47F912
#+begin_src sh :tangle "~/util/txmk" :shebang "#!/usr/bin/env bash"
⟪ltxmk-fun⟫
txmk "$1"
#+end_src
...
*** exif
:PROPERTIES:
:ID:       org_grant_2023-01-01T13-23-35-06-00_donutron:96FD18BE-2059-4869-B9C2-A49CC782D08B
:END:

#+NAME: org_grant_2023-01-01T13-23-35-06-00_donutron_E1D3FD58-CE5A-46C9-BCC0-38C84DF03447
#+begin_src sh
