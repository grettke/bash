...
digraph version5 {
  ...
  subgraph cluster_0 {
    ...
    BashCore[label = "{BashCore|+ \l|+ \l}"]
    BashInteractiveCore[label = "{BashInteractiveCore|+ \l|+ \l}"]
  }
  subgraph cluster_1 {
