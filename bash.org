...
#+BEGIN_SRC shell bash :tangle ./.bash_global_non_interactive
<<BashCore>>
<<BashNonInteractiveCore>>
#+END_SRC
...
#+BEGIN_SRC shell bash :tangle ./.bash_global_interactive
<<BashCore>>
<<BashInteractiveCore>>
#+END_SRC
...
#+BEGIN_SRC shell bash :tangle ./.bash_profile
...
#+BEGIN_SRC shell bash :tangle ./.bashrc
...
#+BEGIN_SRC shell bash :tangle ./.bash_logout
