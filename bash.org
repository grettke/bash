...
- [[http://perlgeek.de/en/article/set-up-a-clean-utf8-environment][How to set up a clean UTF-8 environment in Linux]]
- [[http://www.cyberciti.biz/faq/os-x-terminal-bash-warning-setlocale-lc_ctype-cannot-change-locale/][OS X Terminal: -bash: warning: setlocale: LC_CTYPE: cannot change locale (UTF-8): No such file or directory]]
- [[https://unix.stackexchange.com/questions/87745/what-does-lc-all-c-do][What does “LC_ALL=C” do?]]
...
digraph version5 {
  ...
  subgraph cluster_C {
    ...
    BashInteractiveEnvProp [shape = "rarrow" label = "BASH_ENV"];
  ...
  BashInteractiveEnvProp -> BashGlobalInteractiveProp;
  BashProfile -> BashRc;
  BashRc -> BashLogout;
...
Provide aliases no matter how limited they may seem they are useful even in
their basic form.
